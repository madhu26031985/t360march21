...
export default function EditSpeechModal({ visible, speech, onClose, onSave }: EditSpeechModalProps) {
  ...
  useEffect(() => {
    if (speech) {
      setSpeechForm({
        ...
        document_url: speech.document_url || '',
      });
    }
  }, [speech]);
      ...
      <View style={styles.modalOverlay}>
        <View style={[styles.speechModal, { backgroundColor: theme.colors.background }]}>
          ...
          <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.formField}>
              <Text style={[styles.fieldLabel, { color: theme.colors.text }]} maxFontSizeMultiplier={1.3}>Google Doc URL *</Text>
            ...
            >
              ...
              <Text style={styles.saveButtonText} maxFontSizeMultiplier={1.3}>
                {isSaving ? 'Updating...' : 'Update Speech'}
              </Text>
            </TouchableOpacity>
          </ScrollView>
        </View>
