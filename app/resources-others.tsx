...
export default function ResourcesOthers() {
      ...
      <View style={styles.resourceHeader}>
        <View style={styles.resourceInfo}>
          <View style={styles.resourceTitleRow}>
            <View style={[styles.resourceTypeIcon, { backgroundColor: '#8b5cf6' }]}>
        ...
        {filteredResources.length === 0 && (
          <View style={styles.emptyState}>
            ...
            <Text style={[styles.emptyStateText, { color: theme.colors.text }]} maxFontSizeMultiplier={1.3}>
              {searchQuery ? 'No resources found' : 'No other resources available'}
            </Text>
            <Text
            ...
            >
              {searchQuery
                ...
                : 'Your Executive Committee will add other resources here'}
            </Text>
          </View>
        )}
      </ScrollView>
