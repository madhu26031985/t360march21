...
import { ArrowLeft, TrendingUp, Settings } from 'lucide-react-native';

export default function VPMCorner() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.header, { backgroundColor: theme.colors.surface, borderBottomColor: theme.colors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: theme.colors.text }]} maxFontSizeMultiplier={1.3}>VPM Corner</Text>
        <View style={styles.headerSpacer} />
      </View>

      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={[styles.heroCard, { backgroundColor: theme.colors.surface }]}>
          <View style={[styles.heroIcon, { backgroundColor: '#16a34a' + '20' }]}>
            <TrendingUp size={48} color="#16a34a" />
          </View>
          <Text style={[styles.heroTitle, { color: theme.colors.text }]} maxFontSizeMultiplier={1.3}>VPM Corner</Text>
          <Text style={[styles.heroDescription, { color: theme.colors.textSecondary }]} maxFontSizeMultiplier={1.3}>
            Vice President Membership - Member growth, retention, and engagement
          </Text>
        </View>
        ...
        <View style={[styles.comingSoonCard, { backgroundColor: theme.colors.surface }]}>
          ...
          <Text style={[styles.comingSoonDescription, { color: theme.colors.textSecondary }]} maxFontSizeMultiplier={1.3}>
            The VPM Corner is under development and will include tools for membership tracking, recruitment campaigns, and member engagement analytics.
          </Text>
        </View>
