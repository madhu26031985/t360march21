...
export default function SecretaryCorner() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.header, { backgroundColor: theme.colors.surface, borderBottomColor: theme.colors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: theme.colors.text }]} maxFontSizeMultiplier={1.3}>Secretary Corner</Text>
        <View style={styles.headerSpacer} />
      </View>

      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={[styles.heroCard, { backgroundColor: theme.colors.surface }]}>
          <View style={[styles.heroIcon, { backgroundColor: '#7c3aed' + '20' }]}>
            <FileText size={48} color="#7c3aed" />
          </View>
          <Text style={[styles.heroTitle, { color: theme.colors.text }]} maxFontSizeMultiplier={1.3}>Secretary Corner</Text>
          <Text style={[styles.heroDescription, { color: theme.colors.textSecondary }]} maxFontSizeMultiplier={1.3}>
            Records management, meeting minutes, and official documentation
          </Text>
        </View>
        ...
        <View style={[styles.comingSoonCard, { backgroundColor: theme.colors.surface }]}>
          ...
          <Text style={[styles.comingSoonDescription, { color: theme.colors.textSecondary }]} maxFontSizeMultiplier={1.3}>
            The Secretary Corner is under development and will include tools for meeting minutes, attendance tracking, and document management.
          </Text>
        </View>
