...
import { ArrowLeft, DollarSign, Settings } from 'lucide-react-native';

export default function TreasurerCorner() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.header, { backgroundColor: theme.colors.surface, borderBottomColor: theme.colors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: theme.colors.text }]} maxFontSizeMultiplier={1.3}>Treasurer Corner</Text>
        <View style={styles.headerSpacer} />
      </View>

      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={[styles.heroCard, { backgroundColor: theme.colors.surface }]}>
          <View style={[styles.heroIcon, { backgroundColor: '#059669' + '20' }]}>
            <DollarSign size={48} color="#059669" />
          </View>
          <Text style={[styles.heroTitle, { color: theme.colors.text }]} maxFontSizeMultiplier={1.3}>Treasurer Corner</Text>
          <Text style={[styles.heroDescription, { color: theme.colors.textSecondary }]} maxFontSizeMultiplier={1.3}>
            Financial management, budgeting, and expense tracking
          </Text>
        </View>
        ...
        <View style={[styles.comingSoonCard, { backgroundColor: theme.colors.surface }]}>
          ...
          <Text style={[styles.comingSoonDescription, { color: theme.colors.textSecondary }]} maxFontSizeMultiplier={1.3}>
            The Treasurer Corner is under development and will include tools for financial reporting, budget management, and expense tracking.
          </Text>
        </View>
