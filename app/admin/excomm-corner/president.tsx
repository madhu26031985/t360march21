...
import { ArrowLeft, Crown, Settings } from 'lucide-react-native';

export default function PresidentCorner() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.header, { backgroundColor: theme.colors.surface, borderBottomColor: theme.colors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: theme.colors.text }]} maxFontSizeMultiplier={1.3}>President Corner</Text>
        <View style={styles.headerSpacer} />
      </View>

      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={[styles.heroCard, { backgroundColor: theme.colors.surface }]}>
          <View style={[styles.heroIcon, { backgroundColor: '#dc2626' + '20' }]}>
            <Crown size={48} color="#dc2626" />
          </View>
          <Text style={[styles.heroTitle, { color: theme.colors.text }]} maxFontSizeMultiplier={1.3}>President Corner</Text>
          <Text style={[styles.heroDescription, { color: theme.colors.textSecondary }]} maxFontSizeMultiplier={1.3}>
            Club leadership, strategic planning, and executive oversight
          </Text>
        </View>
        ...
        <View style={[styles.comingSoonCard, { backgroundColor: theme.colors.surface }]}>
          ...
          <Text style={[styles.comingSoonDescription, { color: theme.colors.textSecondary }]} maxFontSizeMultiplier={1.3}>
            The President Corner is under development and will include tools for club leadership, strategic planning, and executive oversight.
          </Text>
        </View>
