-- Ah Counter first-paint fast path:
-- Add `club_name` and top-level `summary_visible_to_members` to the small snapshot
-- so the screen avoids extra initial round-trips.
...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    'summary_visible_to_members', COALESCE((
