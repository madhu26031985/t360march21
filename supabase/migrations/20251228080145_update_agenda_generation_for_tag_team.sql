/*
  # Update Agenda Generation for Tag Team

  ## Summary
  Updates the auto_generate_meeting_agenda function to handle Tag Team section.
  When encountering the tag_team role_classification, it fetches Timer, Ah Counter,
  and Grammarian assignments and creates a single agenda item with all three roles.

  ## Changes
  1. Add special handling for tag_team role_classification
  2. Populate timer_user_id, ah_counter_user_id, grammarian_user_id fields
  3. Create single agenda item for all three Tag Team roles

  ## Logic
  - When template has role_classification = 'tag_team'
  - Fetch Timer, Ah Counter, and Grammarian from app_meeting_roles_management
  - Create one agenda item with all three user IDs
*/
