/*
  Public agenda: expose meeting theme for minimal Toastmaster card.
  Prefer app_club_meeting.theme; fallback to latest toastmaster_meeting_data.theme_of_the_day.
*/
...
COMMENT ON FUNCTION public.get_public_meeting_agenda_by_club(uuid, text, uuid) IS
  'Public agenda: meeting+club+items, including meeting theme for minimal Toastmaster section.';
