/*
  Public agenda: always prefer full profile name for assigned_user_name.
  This avoids showing shortened legacy values like "Shankar Sriniv..." from
  meeting_agenda_items.assigned_user_name in mobile/web public agenda cards.
*/
...
COMMENT ON FUNCTION public.get_public_meeting_agenda_by_club(uuid, text, uuid) IS
  'Public agenda: meeting+club+items, preferring profile full names for assigned roles.';
