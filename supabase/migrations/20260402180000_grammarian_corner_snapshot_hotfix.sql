-- Hotfix: stabilize get_grammarian_corner_snapshot runtime (avoid 400 from RPC).
-- Keep payload compact, but use conservative column usage compatible with existing schema.
