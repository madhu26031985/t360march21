/*
  # Update Agenda Generation for Educational Speaker
  
  ## Summary
  Updates the auto-generate agenda function to include Educational Speaker section.
  Educational speakers are stored in app_meeting_educational_speaker table, not in role management.
  
  ## Changes
  1. Add educational_speaker handling in the agenda generation function
  2. Query from app_meeting_educational_speaker table instead of role management
    ...
    IF v_template.role_classification = 'educational_speaker' THEN
      ...
      LOOP
        INSERT INTO meeting_agenda_items (
          ...
          jsonb_build_object(
            'educational_topic', v_educational.speech_title,
...
COMMENT ON FUNCTION auto_generate_meeting_agenda IS 
  'Auto-generates meeting agenda items based on templates and booked roles. Includes educational speaker handling from app_meeting_educational_speaker table.';