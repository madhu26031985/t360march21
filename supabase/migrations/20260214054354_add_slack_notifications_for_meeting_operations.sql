/*
  # Add Slack Notifications for Meeting Operations

  1. Changes
    - Creates database triggers on meetings table
...
-- Create function to notify Slack when a meeting is created or updated
